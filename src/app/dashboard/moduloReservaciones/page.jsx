...
export default function CapsulaReservaciones() {
    return (
                ...
                <div className="mx-auto max-w-4xl">
                    ...
                    <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={1}>
                        ...
                        <h1 className={michroma.className + " text-[1.5rem] leading-[1.08] sm:text-[2rem] lg:text-[2.4rem]"}>
                            ...
                            <span className="bg-gradient-to-r from-cyan-600 via-sky-500 to-indigo-600 bg-clip-text text-transparent">Reservaciones</span>
                        </h1>
                    </motion.div>
                    ...
                    <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={2.5} className="mt-6">
                        <div className="rounded-[1.75rem] border border-white/70 bg-white/88 p-6 shadow-[0_28px_80px_rgba(15,23,42,0.12)] backdrop-blur-xl sm:p-8">
                            ...
                            <p className="mt-3 text-[14px] leading-relaxed text-slate-600">
                                En esta cápsula aprenderás el flujo completo de reservaciones: crear citas, modificar estados, filtrar por profesional, fecha o estado, y gestionar cancelaciones y reprogramaciones.
                            </p>
                        </div>
                    </motion.div>
                </div>
