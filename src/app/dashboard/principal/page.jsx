...
export default function CapsulaPrincipal() {
    return (
                ...
                <div className="mx-auto max-w-4xl">
                    ...
                    <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={1}>
                        ...
                        <h1 className={michroma.className + " text-[1.5rem] leading-[1.08] sm:text-[2rem] lg:text-[2.4rem]"}>
                            <span className="text-slate-900">Vista </span>
                            <span className="bg-gradient-to-r from-cyan-600 via-sky-500 to-indigo-600 bg-clip-text text-transparent">Principal</span>
                        </h1>
                    </motion.div>
                    ...
                    <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={2.5} className="mt-6">
                        <div className="rounded-[1.75rem] border border-white/70 bg-white/88 p-6 shadow-[0_28px_80px_rgba(15,23,42,0.12)] backdrop-blur-xl sm:p-8">
                            ...
                            <p className="mt-3 text-[14px] leading-relaxed text-slate-600">
                                Este es el Panel Principal de AgendaClinica, donde podrás gestionar y visualizar todas las reservaciones de manera rápida, simple y organizada.
                            </p>
                            <p className="mt-3 text-[14px] leading-relaxed text-slate-600">
                                Desde este módulo es posible revisar citas agendadas, estados de atención, profesionales asignados y la información general de cada reserva en tiempo real, permitiendo un mejor control y administración de la agenda clínica.
                            </p>
                        </div>
                    </motion.div>
                </div>
